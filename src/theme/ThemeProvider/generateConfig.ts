...
export default (variant: Variant) => {
	...
	const fontColors = {
		...
		...(variantConfig && hasProperty(variantConfig, "fonts.colors") ? variantConfig.fonts.colors : {}),
	}
	const backgroundColors = {
		...defaultConfig.backgrounds,
		...(variantConfig && hasProperty(variantConfig, "backgrounds") ? variantConfig.backgrounds : {}),
	}
	const borderColors = {
		...defaultConfig.borders.colors,
		...(variantConfig && hasProperty(variantConfig, "borders.colors") ? variantConfig.borders.colors : {}),
	}
	const navigationColors = {
		...defaultConfig.navigationColors,
		...(variantConfig && hasProperty(variantConfig, "navigationColors") ? variantConfig.navigationColors : {}),
	}
	const colors = {
